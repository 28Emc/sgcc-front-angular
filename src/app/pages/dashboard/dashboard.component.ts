...
import { WidgetLargeChartComponent } from './widgets/widget-large-chart/widget-large-chart.component';
...
import { WidgetQuickValueCenterComponent } from './widgets/widget-quick-value-center/widget-quick-value-center.component';
import { WidgetTableComponent } from './widgets/widget-table/widget-table.component';
import { defaultChartOptions } from '@vex/utils/default-chart-options';
import { TableColumn } from '@vex/interfaces/table-column.interface';
import { Order, tableSalesData } from 'src/app/utils/fake-data';
